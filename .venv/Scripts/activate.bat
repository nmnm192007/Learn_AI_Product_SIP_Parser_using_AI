...
@set "VIRTUAL_ENV=C:\Users\edghklt\OneDrive - Ericsson\NM Personal Reference Downloads\Learn\code_folder\Learn_AI\Phase0\Learn_AI_Product_Answering_Machine_using_AI\.venv"
